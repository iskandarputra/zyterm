...
**1.4.0**). It opens a serial port (or a `tcp://` / `telnet://` transport), renders RX in a small
...
- **Version source of truth.** `ZT_VERSION` is `"1.4.0"` at `src/zt_ctx.h:70`. Release tagging
